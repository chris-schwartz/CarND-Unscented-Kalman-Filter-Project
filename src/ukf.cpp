...
double UKF::ComputeElapsedTimeInSeconds(MeasurementPackage measurement_pack) {
    long current_time = measurement_pack.timestamp_;
    double delta_t_seconds = (current_time - previous_timestamp_) / 1e6;
