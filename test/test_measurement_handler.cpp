...
TestMeasurementHandler::TestMeasurementHandler() : TestCase("TestMeasurementHandler") {
    add_test("testUpdate", &TestMeasurementHandler::testUpdate);
}
TestMeasurementHandler::~TestMeasurementHandler() {

}
void TestMeasurementHandler::testUpdate() {
    ...
    handler.Update(prediction, z, Xsig_pred, weights, x, P);
    ...
    EigenAssert::assertMatricesEqual(x, expected_x, 0.001);
}
